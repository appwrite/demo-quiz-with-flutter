...
5. In the appwrite console in your project, it will create new collection, get the id of that collection and replace update `lib/constants.dart` with your own `ednpoint`, `project id` and `collection id`
